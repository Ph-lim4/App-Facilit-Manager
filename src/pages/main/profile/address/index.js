...
const address = (props) => {
  return (
    <Container>
      <Header title={"Endereço"} onPress={() => props.navigation.navigate("ProfileOverview")}/>
      ...
      <Input placeholder={"Complemento"} marginTop={13} onChangeText={text => console.log(text)}/>
      <Input placeholder={"*Mapa*"} marginTop={13} height={100} onChangeText={text => console.log(text)}/>
      <Footer height={250} onPress={() => props.navigation.navigate("ProfileOverview")}/>
    </Container>
  );
}
