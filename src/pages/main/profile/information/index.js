...
const information = (props) => {
  return (
    <Container>
      <Header title={"Informações"} onPress={() => props.navigation.navigate("ProfileOverview")}/>
      ...
      <Input placeholder={"Email"} marginTop={13} password onChangeText={text => console.log(text)}/>
      <Input placeholder={"Senha"} marginTop={13} password onChangeText={text => console.log(text)}/>
